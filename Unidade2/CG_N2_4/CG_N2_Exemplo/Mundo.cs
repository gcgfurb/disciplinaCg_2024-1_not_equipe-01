...
namespace gcgcg
{
    public class Mundo : GameWindow
    {
        ...
        private char rotuloSpline = '?';
        private char rotuloPoligono = '?';
        private int indexPontoAtual = 0;
        private Objeto objetoSelecionado = null;

        private readonly float[] _sruEixos =
        {
            0.0f, 0.0f, 0.0f, /* Origem */
            0.5f, 0.0f, 0.0f, /* Eixo X positivo */
            0.0f, 0.0f, 0.0f, /* Origem */
            0.0f, 0.5f, 0.0f, /* Eixo Y positivo */
        };
        ...
        protected override void OnLoad()
        {
            ...
            GL.ClearColor(0.5f, 0.5f, 0.49f, 1.0f);
            ...
            lista.Add(new Ponto4D(0.5, -0.5));
            lista.Add(new Ponto4D(0.5,0.5));
            lista.Add(new Ponto4D(-0.5, 0.5));
            lista.Add(new Ponto4D(-0.5,-0.5));

            objetoSelecionado = new Spline(mundo, ref rotuloAtual, lista);
            rotuloSpline = rotuloAtual;
            objetoSelecionado.shaderObjeto = new Shader("Shaders/shader.vert", "Shaders/shaderAmarela.frag");

            objetoSelecionado = new Poligono(mundo, ref rotuloAtual, lista);
            rotuloPoligono = rotuloAtual;
            objetoSelecionado.shaderObjeto = new Shader("Shaders/shader.vert", "Shaders/shaderCiano.frag");

            objetoSelecionado = new Ponto(mundo, ref rotuloAtual, lista[1]);
            objetoSelecionado = new Ponto(mundo, ref rotuloAtual, lista[2]);
            objetoSelecionado = new Ponto(mundo, ref rotuloAtual, lista[3]);
            objetoSelecionado = new Ponto(mundo, ref rotuloAtual, lista[0]);
                    ...
                    {
                        {
                            if (input.IsKeyPressed(Keys.Space))
                            {
                                ...
                                if (objetoSelecionado.GetType().Equals(typeof(Ponto)))
                            ...
                            else if (input.IsKeyPressed(Keys.C))
                            {
                                ...
                                Ponto pontoAtual = (Ponto)objetoSelecionado;
                                pontoAtual.PontosId(0).Y += 0.1;
                                
                                objetoSelecionado.ObjetoAtualizar();
                                
                                Poligono poligono = (Poligono)mundo.GrafocenaBusca(rotuloPoligono);
                                poligono.PontosAlterar(pontoAtual.PontosId(0), indexPontoAtual);
                                poligono.ObjetoAtualizar();

                                Spline spline = (Spline)mundo.GrafocenaBusca(rotuloSpline);
                                spline.AtualizarSpline(poligono.GetPonto4Ds());
                            }
                            ...
                            else if (input.IsKeyPressed(Keys.Minus)) // Diminui qtd pontos
                            {
                                Poligono poligono = (Poligono)mundo.GrafocenaBusca(rotuloPoligono);

                                Spline spline = (Spline)mundo.GrafocenaBusca(rotuloSpline);
                                spline.SplineQtdPonto(-1);
                                spline.AtualizarSpline(poligono.GetPonto4Ds());
                            }
                            else if (input.IsKeyPressed(Keys.Comma)) // Aumenta qtd pontos
                            {
                                Poligono poligono = (Poligono)mundo.GrafocenaBusca(rotuloPoligono);
