...
namespace gcgcg
{
  internal class Objeto  //TODO: deveria ser uma class abstract ..??
  {
    ...
    public Objeto GrafocenaBuscaProximo(Objeto objetoAtual)
    {
      ...
      if (objetoAtual != null)
      {
        if (objetoAtual.PrimitivaTipo == PrimitiveType.Points)
          objetoAtual.PrimitivaTipo = PrimitiveType.Lines;
        else if (objetoAtual.PrimitivaTipo == PrimitiveType.Lines)
          objetoAtual.PrimitivaTipo = PrimitiveType.LineLoop;
        else if (objetoAtual.PrimitivaTipo == PrimitiveType.LineLoop)
          objetoAtual.PrimitivaTipo = PrimitiveType.LineStrip;
        else if (objetoAtual.PrimitivaTipo == PrimitiveType.LineStrip)
          objetoAtual.PrimitivaTipo = PrimitiveType.Triangles;
        else if (objetoAtual.PrimitivaTipo == PrimitiveType.Triangles)
          objetoAtual.PrimitivaTipo = PrimitiveType.TriangleStrip;
        else if (objetoAtual.PrimitivaTipo == PrimitiveType.TriangleStrip)
          objetoAtual.PrimitivaTipo = PrimitiveType.TriangleFan;
        else if (objetoAtual.PrimitivaTipo == PrimitiveType.TriangleFan)
          objetoAtual.PrimitivaTipo = PrimitiveType.Points;

        return objetoAtual;
      }
      else
      {
        Objeto novoObjeto = GrafocenaBusca(Utilitario.CharProximo('@'));

        if (novoObjeto.PrimitivaTipo == PrimitiveType.Points)
          novoObjeto.PrimitivaTipo = PrimitiveType.Lines;
        else if (novoObjeto.PrimitivaTipo == PrimitiveType.Lines)
          novoObjeto.PrimitivaTipo = PrimitiveType.LineLoop;
        else if (novoObjeto.PrimitivaTipo == PrimitiveType.LineLoop)
          novoObjeto.PrimitivaTipo = PrimitiveType.LineStrip;
        else if (novoObjeto.PrimitivaTipo == PrimitiveType.LineStrip)
          novoObjeto.PrimitivaTipo = PrimitiveType.Triangles;
        else if (novoObjeto.PrimitivaTipo == PrimitiveType.Triangles)
          novoObjeto.PrimitivaTipo = PrimitiveType.TriangleStrip;
        else if (novoObjeto.PrimitivaTipo == PrimitiveType.TriangleStrip)
          novoObjeto.PrimitivaTipo = PrimitiveType.TriangleFan;
        else if (novoObjeto.PrimitivaTipo == PrimitiveType.TriangleFan)
          novoObjeto.PrimitivaTipo = PrimitiveType.Points;
